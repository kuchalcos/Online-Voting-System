...
// include connect.php (use __DIR__ to ensure correct relative path)
include __DIR__ . "/connect.php"; // this should set $connect
...
// NOTE: there are 6 placeholders => bind_param needs 6 types/values
...
// 5 strings (name,mobile,hashed,address,photo) and 1 integer (role) => "sssssi"
